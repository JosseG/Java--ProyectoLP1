...
public class AMenuPrincipal extends JFrame implements ActionListener,ComponentListener {
	...
	private JMenuItem mntmConsultaRecibo;
	...
	public AMenuPrincipal() {
		...
		mntmConsultaRecibo = new JMenuItem("Consulta Recibo");
		mntmConsultaRecibo.addActionListener(this);
		mnConsulta.add(mntmConsultaRecibo);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == mntmConsultaRecibo) {
	...
	protected void actionPerformedMntmConsultaRecibo(ActionEvent e) {
		FConsultaRecibo Con22 = new FConsultaRecibo();		
		fondo1.add(Con22);
